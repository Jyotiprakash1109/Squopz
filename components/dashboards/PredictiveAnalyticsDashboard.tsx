    ...
    <div className="space-y-12">
      ...
      >
        ...
        <p className="text-gray-300 text-lg leading-relaxed">
          Add your dashboard description here. This section showcases the Predictive Analytics Dashboard
          that you have built. Describe the machine learning models, forecasting capabilities, and anomaly detection features.
        </p>
      </motion.div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="p-6">
              <h3 className="text-lg font-bold text-white mb-2">Forecast Overview</h3>
          ...
          >
            ...
            <div className="p-6">
              <h3 className="text-lg font-bold text-white mb-2">Insights & Reports</h3>
              <p className="text-gray-400 text-sm">
                Add description for this dashboard screenshot
              </p>
            </div>
