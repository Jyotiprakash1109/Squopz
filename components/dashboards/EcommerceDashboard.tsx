    ...
    <div className="space-y-12">
      ...
      >
        ...
        <p className="text-gray-300 text-lg leading-relaxed">
          Add your dashboard description here. This section showcases the E-Commerce Dashboard
          that you have built. Describe the order management, inventory tracking, and customer insights features.
        </p>
      </motion.div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl overflow-hidden group cursor-pointer hover:border-pink-400/50 transition-all"
          >
          ...
          <motion.div
            ...
            className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl overflow-hidden group cursor-pointer hover:border-red-400/50 transition-all"
          >
            <div className="aspect-video bg-gradient-to-br from-white/10 to-white/5 flex items-center justify-center group-hover:from-white/15 group-hover:to-white/10 transition-all">
              <div className="text-center">
                <ImagePlus className="w-12 h-12 text-gray-400 mx-auto mb-3" />
            ...
            <div className="p-6">
              <h3 className="text-lg font-bold text-white mb-2">Inventory Status</h3>
              <p className="text-gray-400 text-sm">
                Add description for this dashboard screenshot
              </p>
            </div>
          ...
          >
            ...
            <div className="p-6">
              <h3 className="text-lg font-bold text-white mb-2">Customer Analytics</h3>
              <p className="text-gray-400 text-sm">
                Add description for this dashboard screenshot
              </p>
            </div>
          ...
          >
            ...
            <div className="p-6">
              <h3 className="text-lg font-bold text-white mb-2">Sales Performance</h3>
              <p className="text-gray-400 text-sm">
                Add description for this dashboard screenshot
              </p>
            </div>
