    ...
    <div className="space-y-12">
      ...
      >
        ...
        <p className="text-gray-300 text-lg leading-relaxed">
          Add your dashboard description here. This section showcases the IoT & Real-Time Monitoring Dashboard
          that you have built. Describe the sensor data visualization, device management, and alert system features.
        </p>
      </motion.div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="p-6">
              <h3 className="text-lg font-bold text-white mb-2">Sensor Data</h3>
              <p className="text-gray-400 text-sm">
                Add description for this dashboard screenshot
              </p>
            </div>
          ...
          >
            ...
            <div className="p-6">
              <h3 className="text-lg font-bold text-white mb-2">Device Management</h3>
              <p className="text-gray-400 text-sm">
                Add description for this dashboard screenshot
              </p>
            </div>
          ...
          >
            ...
            <div className="p-6">
              <h3 className="text-lg font-bold text-white mb-2">Alerts & Notifications</h3>
              <p className="text-gray-400 text-sm">
                Add description for this dashboard screenshot
              </p>
            </div>
