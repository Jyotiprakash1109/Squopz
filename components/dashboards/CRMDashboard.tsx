    ...
    <div className="space-y-12">
      ...
      >
        ...
        <p className="text-gray-300 text-lg leading-relaxed">
          Add your dashboard description here. This section showcases the CRM Dashboard
          that you have built. Describe the key features, customer management capabilities, and sales tracking functionality.
        </p>
      </motion.div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="p-6">
              <h3 className="text-lg font-bold text-white mb-2">Customer Overview</h3>
          ...
          >
            ...
            <div className="p-6">
              <h3 className="text-lg font-bold text-white mb-2">Sales Pipeline</h3>
              <p className="text-gray-400 text-sm">
                Add description for this dashboard screenshot
              </p>
            </div>
